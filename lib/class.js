...
var superExtend = function(base, props, mashing) {
  ...
  for(var prop in props) {
    ...
    if ( prop.match(/prototype|__proto__/) ) { continue; }
...
Class.subclass = function(iProps, cProps) {
  initializing = true;
  var proto = new this();
  initializing = false;
  ...
  Class._subclass = Class.subclass;
...
module.exports = function(iProps, cProps) {
  return Class.subclass(iProps, cProps);
};
